...
echo -e "       (the tag must be GPG-signed with a key listed in .github/release-signers.asc;"
echo -e "        pushing it triggers .github/workflows/publish-release.yml, which stages the"
echo -e "        release to Sonatype Central Portal for you to finish manually)"
