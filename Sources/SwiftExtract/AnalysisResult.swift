...
public struct AnalysisResult {
  ...
  /// the only way these sources can add conformances or members to a foreign type. This
  /// is therefore the complete record of what the analysis learned about types it does
  /// not declare.
  ///
  /// Separate from `extractedTypes`, which is the set of types a generator should emit.
