...
final class SwiftAnalysisVisitor {
  ...
  ///
  /// Never fails as a whole. A clause holding one unrepresentable requirement still
  /// contributes the rest, and the flag keeps the conformance from looking unconditional
